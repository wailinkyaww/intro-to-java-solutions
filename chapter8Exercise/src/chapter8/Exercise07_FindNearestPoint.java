...
public class Exercise07_FindNearestPoint {
	public static void main(String[] args) {
		...
		System.out.println("The cloest two points are (" + points[p1][0] + ", " + points[p1][1] + ", "+ points[p1][2] + ") and ("
				+ points[p2][0] + ", " + points[p2][1] + ", " + points[p2][2] + ")");
	}

	// Calculate distance between two points of three dimension
